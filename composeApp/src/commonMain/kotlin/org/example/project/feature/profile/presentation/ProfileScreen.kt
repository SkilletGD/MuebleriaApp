...
fun ProfileScreen(
    ...
    val scrollState = rememberScrollState() // 1. Creamos el estado
            ...
            is ProfileUiState.Success -> {
                Column(modifier = Modifier.padding(20.dp)) {
                    Row(
                        ...
                        //por ahora estaticos para pruebas
                    ...
                    Card(
                        ...
                        Column(Modifier.padding(16.dp)) {
                            ...
                            InfoRow(
                                ...
                                label = "Miembro desde",
                                value = formatFecha(s.profile.fechaRegistro) // <--- Llamamos a una función para que se vea bien
                            )
                        }
                    }
                    ...
                    Button(
                        ...
                        Icon(Icons.Default.ExitToApp, null, tint = WoodError)
